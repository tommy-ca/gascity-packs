...
4. Canonical vendor is Cursor pstack at `https://github.com/cursor/plugins` path `pstack` commit `6fecddba65801f9b9c08b8b328d998ee5b09d290`. Listed vendor paths are skills, README, and LICENSE. Do not pin `tommy-ca/pstack`. Packing follows gascity-packs workflow packs on Gas City primitives. See `ARCHITECTURE.md`.
