...
- `gc pack registry publish --dry-run pstack/` is proven from this branch. `gc pack registry whoami` succeeds. Submit waits on the operator review-gate. Catalog restamp of gastownhall `registry.toml` is not that dest.
