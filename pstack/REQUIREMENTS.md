...
- `gc pack registry publish --dry-run pstack/` is proven from this branch. Submit waits on `gc pack registry login`. Catalog restamp of gastownhall `registry.toml` is not that dest.
