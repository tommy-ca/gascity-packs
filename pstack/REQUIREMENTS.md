...
4. Discipline source is Cursor pstack tree `6fecddba65801f9b9c08b8b328d998ee5b09d290`. Runtime vendor is the pin in `vendor/pstack/`. Packing follows gascity-packs workflow packs on Gas City primitives. See `ARCHITECTURE.md`.
