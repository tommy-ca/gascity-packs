# gascity-provider-panel Specification

## Purpose

Define how a Gas City city lists N provider catalog ids for arena and
interrogate fanout, without pack formulas naming providers or models.
